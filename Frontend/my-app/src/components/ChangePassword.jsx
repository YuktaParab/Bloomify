    ...
    <div className="min-h-screen bg-(--bg) flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="bg-(--card) border border-(--border) rounded-3xl shadow-xl p-8 md:p-10 backdrop-blur-sm">
          ...
          <h2 className="text-2xl font-black text-center text-(--text) mb-1">Change Password</h2>
          <p className="text-sm text-center text-(--text-muted) mb-8">Set a new secure password</p>
          ...
          <form onSubmit={handlesubmit} className="space-y-5">
            ...
            <AnimatedButton variant="ghost" size="md" className="w-full" onClick={() => nav("/home")}>
